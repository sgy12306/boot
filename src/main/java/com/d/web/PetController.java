...
public class PetController {
    ...
    public Object edit(@ApiParam("宠物id") @RequestParam(defaultValue = "1") int id) {
        Pet pet = petService.get(id);
        return Result.assertNull(pet);
    }
    ...
    @ApiOperation(value = "保存", notes = "宠物保存")
    @PostMapping(path = "/pet/save")
    public Object save(Integer id) {
        return Result.success(petService.save(id));
    }
