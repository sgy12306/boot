...
public class Result {
    ...
    public static Result assertNull(Object data) {
        return data == null ? fail("") : success(data);
    }

    public static Result assertZero(Integer data) {
        return data == null || data == 0 ? fail("") : success(data);
    }
